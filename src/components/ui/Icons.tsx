export function FileIcon({ className = "w-8 h-8 text-text-muted shrink-0" }: { className?: string }) {
  return (
...
export function CheckIcon({ className = "w-5 h-5 text-accent shrink-0" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function UploadIcon({ className = "w-8 h-8 text-text-muted" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
...
export function ChevronRightIcon({ className = "w-5 h-5 text-text-muted" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
